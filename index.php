            ...
            <div class=\"modal-content\">
                ...
                <div class=\"modal-body\">
                    <form id=\"form_edit_produto\" method=\"post\">
                        ...
                        <div><span>Descrição do Produto</span><input class=\"form-control\" type=\"text\" id=\"edit_input_descricao\" required=\"\" style=\"max-width: 350px;\" name=\"nome_produto\"></div>
                        <div><span>Marca</span><input class=\"form-control\" type=\"text\" id=\"edit_input_marca\" style=\"max-width: 250px;\" required=\"\" name=\"marca_produto\">
                            <div style=\"padding: 5px;padding-right: 0;padding-left: 0;margin-top: -11px;\"></div>
                        </div>
                        <div><span>Estoque</span><input class=\"form-control\" type=\"text\" id=\"edit_input_estoque\" style=\"max-width: 160px;\" inputmode=\"numeric\" required=\"\" pattern=\"^([0-9]*)?$\" name=\"estoque_produto\">
                        ...
                        <div><span>Preço</span><input class=\"form-control\" type=\"text\" id=\"edit_input_preco\" style=\"max-width: 200px;\" inputmode=\"numeric\" required=\"\" pattern=\"^[1-9]\d*(,[0-9]{1,2})?$\" name=\"preco_produto\">
            ...
            <div class=\"modal-content\">
                ...
                <div class=\"modal-body\">
                    <form id=\"form_cadastrar_produto\" method=\"post\">
                        <div><span>Descrição do Produto</span><input class=\"form-control\" type=\"text\" required=\"\" style=\"max-width: 350px;\" name=\"nome_produto\" autocomplete=\"off\"></div>
                        <div><span>Marca</span><input class=\"form-control\" type=\"text\" style=\"max-width: 140px;\" required=\"\" name=\"marca_produto\" autocomplete=\"off\">
                            <div style=\"padding: 5px;padding-right: 0;padding-left: 0;margin-top: -11px;\"></div>
                        </div>
                        ...
                        <div><span>Preço</span><input class=\"form-control\" type=\"text\" style=\"max-width: 200px;\" inputmode=\"numeric\" required=\"\" pattern=\"^[1-9]\d*(,[0-9]{1,2})?$\" name=\"preco_produto\" autocomplete=\"off\">
                            <div style=\"padding: 5px;padding-right: 0;padding-left: 0;margin-top: -11px;\"><span style=\"font-size: 12px;\">Formato aceito: números e vírgula. Ex: 10,25</span></div>
                        </div>
                    </form>
                </div>
